...
enter your choice
 ...
 enter the namegraphs

 enter the namehashfunction
 ...
 Enter the name of chapter on which you want to enter the sectiontrees

 how many sections you want to enter2

 enter the namebinary tree
...
#####
 ...
 Enter the name of chapter on which you want to enter the sectiongraph
 ...
 NAME OF BOOK:  dsa
                NAME OF CHAPTER:  trees
                                NAME OF SECTION:  binary
                                NAME OF SECTION:  tree
                NAME OF CHAPTER:  graphs
                NAME OF CHAPTER:  hashfunction
...
--------------------------------
Process exited after 124 seconds with return value 0
